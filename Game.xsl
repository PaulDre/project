        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <xsl:if test=".//id = 1">
                ...
                <svg>
                    ...
                    <text x="100" y="28" font-size="10" fill="black" alignment-baseline="middle"
                        text-anchor="middle" font-weight="bold" letter-spacing="2.5">please enter the number of player! </text>
                </svg>
            </xsl:if>
            ...
            <xsl:if test=".//id = 1">
                ...
                <svg>
                    ...
                    <text x="100" y="28" font-size="8" fill="black" alignment-baseline="middle"
                        text-anchor="middle" font-weight="bold" letter-spacing="2.5">please enter the number of cards! </text>
                </svg>
            </xsl:if>

            <!-- Buttons "16, 24, 32" -->
            <xsl:if test="kButton//id = 1">
                <a href="Gamescreen16.xml">
                <svg>
                    <circle r="8" fill="black" cx="65" cy="55" style="fill-opacity:0.8"/>
